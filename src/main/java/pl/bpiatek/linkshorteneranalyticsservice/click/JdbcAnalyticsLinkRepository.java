...
class JdbcAnalyticsLinkRepository implements  AnalyticsLinkRepository {
    ...
    public void save(AnalyticsLink link) {
        ...
        final String sql = """
            INSERT INTO analytics_links (short_url, link_id, user_id, is_active, updated_at)
            VALUES (:shortUrl, :linkId, :userId, :isActive, :updatedAt)
    ...
    @Override
    public void deactivate(String shortUrl) {
        final String sql = """
        ...
        namedJdbcTemplate.update(sql, Map.of("shortUrl", shortUrl));
    }
}